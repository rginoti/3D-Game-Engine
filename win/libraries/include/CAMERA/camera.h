...
//		Translate[3][0] = -glm::dot(xaxis, Position);
//		Translate[3][1] = -glm::dot(yaxis, Position);
//		Translate[3][2] = -glm::dot(zaxis, Position);
		Translate[3][0] = -Position.x;
		Translate[3][1] = -Position.y;
		Translate[3][2] = -Position.z;
			// Return lookAt matrix as combination of translation and rotation matrix
		return Result * Translate; // Remember to read from right to left (first translation then rotation)
	}
