...
int main()
{
	...
	glEnable(GL_DEPTH_TEST);
		...
		// ------------------------------------
	Shader lightingShader("../../../libraries/shaders/vertex9.txt", "../../../libraries/shaders/fragment9.txt");
...
//	unsigned char *data = stbi_load("../../../assets/chest.png", &width, &height, &nrChannels, 0);
