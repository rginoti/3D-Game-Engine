...
//	glfwWindowHint(GLFW_SAMPLES, 4);
	...
	glEnable(GL_DEPTH_TEST);
		...
		// -------------------------
//	Shader shader("../../../libraries/shaders/vertex29.glsl", "../../../libraries/shaders/fragment29.glsl");
	Shader shader("../../../libraries/shaders/vertex29.glsl", "../../../libraries/shaders/fragment29.glsl", "../../../libraries/shaders/geometry29.glsl");
	
	
	unsigned int diffuseMap = loadTexture("../../../assets/bricks.jpg");
	unsigned int normalMap = loadTexture("../../../assets/bricks_normal.jpg");
	unsigned int depthMap = loadTexture("../../../assets/bricks_disp.jpg");
	shader.use();
