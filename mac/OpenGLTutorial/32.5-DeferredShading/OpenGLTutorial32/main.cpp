...
//	glfwWindowHint(GLFW_SAMPLES, 4);
	...
	glEnable(GL_DEPTH_TEST);
		...
		// -------------------------
	Shader shaderGeometryPass("/Users/ronaldginoti/Documents/C++/libraries/shaders/vertex32GeometryPass.glsl", "/Users/ronaldginoti/Documents/C++/libraries/shaders/fragment32GeometryPass.glsl");
	Shader shaderLightingPass("/Users/ronaldginoti/Documents/C++/libraries/shaders/vertex32LightingPass.glsl", "/Users/ronaldginoti/Documents/C++/libraries/shaders/fragment32.5LightingPass.glsl");
	Shader shaderLightBox("/Users/ronaldginoti/Documents/C++/libraries/shaders/vertex32LightBox.glsl", "/Users/ronaldginoti/Documents/C++/libraries/shaders/fragment32LightBox.glsl");
	
	Model nanosuit("/Users/ronaldginoti/Documents/C++/assets/nanosuit/nanosuit.obj");
...
//	glPolygonMode(GL_FRONT_AND_BACK, GL_LINE);
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		for (unsigned int i = 0; i < lightPositions.size(); i++)
		{
			...
			float radius = ((-linear + std::sqrt(linear * linear - 4 * quadratic * (constant - (256.0f / 5.0f) * maxBrightness))) / (2.0f * quadratic)) / 2;
