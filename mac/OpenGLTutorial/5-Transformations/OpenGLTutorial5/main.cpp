...
int main() 
{
	...
	Shader ourShader1("/Users/ronaldginoti/Documents/C++/libraries/shaders/vertex5.txt", "/Users/ronaldginoti/Documents/C++/libraries/shaders/fragment5.txt");
...
//		ourShader1.use();
		...
		unsigned int transformLoc2 = glGetUniformLocation(ourShader1.ID, "transform");
