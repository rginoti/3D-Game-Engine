...
int main()
{
	...
	glEnable(GL_DEPTH_TEST);
		...
		// ------------------------------------
	Shader lightingShader("/Users/ronaldginoti/Documents/C++/OpenGL/libraries/shaders/vertex9.txt", "/Users/ronaldginoti/Documents/C++/OpenGL/libraries/shaders/fragment9.txt");
...
//	unsigned char *data = stbi_load("/Users/ronaldginoti/Documents/C++/assets/chest.png", &width, &height, &nrChannels, 0);
...
//	glm::vec3 lightAmbient(0);
//	glm::vec3 lightDiffuse(0);
//	glm::vec3 lightSpecular(0);
