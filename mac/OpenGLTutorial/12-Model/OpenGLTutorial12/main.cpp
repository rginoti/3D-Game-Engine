...
int main()
{
	...
	glEnable(GL_DEPTH_TEST);
		...
		// -------------------------
	Shader ourShader("/Users/ronaldginoti/Documents/C++/OpenGL/libraries/shaders/vertex12.glsl", "/Users/ronaldginoti/Documents/C++/OpenGL/libraries/shaders/fragment12.glsl");
	
		// load models
		// -----------
	Model ourModel("/Users/ronaldginoti/Documents/C++/OpenGL/assets/nanosuit/nanosuit.obj");
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		setPointLightUniform(4, pointLightPositions, pointLightColors1, &ourShader);
